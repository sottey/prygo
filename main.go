...
func run() error {
	...
	flag.CommandLine.Usage = func() {
		...
		fmt.Println("Use `prygo revert [paths]` to manually restore files if a run crashes.")
		fmt.Println("Use `-generate` to write a pry-injected file without executing it (great for sharing repros).")
		fmt.Println("prygo mirrors your module's go/toolchain directives inside scratch workspaces, so temporary builds match your environment.")
